package com.example.healthmetricplus.data.repository

import com.example.healthmetricplus.data.mapper.BodyPartDto
import com.example.healthmetricplus.data.mapper.BodyPartValueDto
import com.example.healthmetricplus.data.mapper.UserDto
import com.example.healthmetricplus.data.mapper.toBodyPart
import com.example.healthmetricplus.data.mapper.toBodyPartDto
import com.example.healthmetricplus.data.mapper.toBodyPartValue
import com.example.healthmetricplus.data.mapper.toBodyPartValueDto
import com.example.healthmetricplus.data.mapper.toUser
import com.example.healthmetricplus.data.util.Constants.BODY_PART_COLLECTION
import com.example.healthmetricplus.data.util.Constants.BODY_PART_NAME_FIELD
import com.example.healthmetricplus.data.util.Constants.BODY_PART_VALUE_COLLECTION
import com.example.healthmetricplus.data.util.Constants.BODY_PART_VALUE_DATE_FIELD
import com.example.healthmetricplus.data.util.Constants.USER_COLLECTION
