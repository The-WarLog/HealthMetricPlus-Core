package com.example.healthmetricplus.data.util
...
object Constants {
    ...
    const val GOOGLE_CLIENT_ID = "936093062231-6mg6ao186d3mul174msmmtakmemk8s2p.apps.googleusercontent.com"
    const val APP_LOG ="HEALTHMETRIC_PLUS_LOG"
